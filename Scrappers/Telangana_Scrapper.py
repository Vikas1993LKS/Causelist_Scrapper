...
from Parsers.PDF_Parser_Telangana import parsepdf
import time
from selenium.webdriver.common.keys import Keys

#today_date = datetime.today().strftime('%d-%m-%Y')
today_date = "03-03-2020"
print(today_date)

chrome_options = Options()
download_dir = r'E:\Scrapping\Telangana\PDF'
try:
...
def Scrapper(url):
    ...
    Date_Selection.send_keys(today_date)
...
url = "https://services.ecourts.gov.in/ecourtindiaHC/cases/highcourt_causelist.php?state_cd=29&dist_cd=1&court_code=1&stateNm=Telangana"
